...
#endif
#ifdef CONFIG_LCD_DRIVER_SCREEN_CONTROLLER_LG4572B
extern scr_driver_t lcd_lg4572b_default_driver;
#endif
...
#endif
#ifdef CONFIG_LCD_DRIVER_SCREEN_CONTROLLER_LG4572B
    case SCREEN_CONTROLLER_LG4572B:
        printf("WAAAA\n");
        *out_screen = lcd_lg4572b_default_driver;
        break;
#endif
