...
ui_func_desc_t ui_full_cleaning_func = {
    .name = "ui_full_cleaning",
    .init = ui_full_cleaning_init,
    .show = ui_full_cleaning_show,
    .hide = ui_full_cleaning_hide,
};
...
static void simulator_cleaning_task(void* data)
{
    ...
    {
        ui_cleaning_full_update(currentStep, totalStep);
        currentStep++;
        vTaskDelay(100);
    }
...
void ui_full_cleaning_init(void *data)
{
    (void)data;
...
void ui_full_cleaning_show(void *data)
{
    if(NULL == obj_label)
    {
        ui_full_cleaning_init(data);
    }
    else
    {
    ...
    // xTaskCreate(simulator_cleaning_task, "Full Cleaning Simulator Task", 4*1024, NULL, 5, NULL);
}

void ui_full_cleaning_hide(void *data)
{
    (void)data;
