...
void ui_preferences_init(void *data)
{
    ...
    lv_obj_set_size(obj_page_settings, PREF_BUTTON_WIDTH, PREF_BUTTON_HEIGHT);
    ...
    lv_obj_set_style_local_radius(obj_page_settings, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, PREF_BUTTON_RADIUS);
    lv_obj_set_style_local_border_width(obj_page_settings, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, PREF_BUTTON_BORDER);
    lv_obj_align(obj_page_settings, NULL, LV_ALIGN_CENTER, -PREF_BUTTON_X_CENTER, -PREF_BUTTON_Y_CENTER +PREF_BUTTON_Y_OFFSET);

    obj_page_statistics = lv_obj_create(lv_scr_act(), NULL);
    lv_obj_set_size(obj_page_statistics, PREF_BUTTON_WIDTH, PREF_BUTTON_HEIGHT);
    ...
    lv_obj_set_style_local_radius(obj_page_statistics, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, PREF_BUTTON_RADIUS);
    lv_obj_set_style_local_border_width(obj_page_statistics, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, PREF_BUTTON_BORDER);
    lv_obj_align(obj_page_statistics, NULL, LV_ALIGN_CENTER, -PREF_BUTTON_X_CENTER, PREF_BUTTON_Y_CENTER +PREF_BUTTON_Y_OFFSET);

    obj_page_factory_reset = lv_obj_create(lv_scr_act(), NULL);
    lv_obj_set_size(obj_page_factory_reset, PREF_BUTTON_WIDTH, PREF_BUTTON_HEIGHT);
    ...
    lv_obj_set_style_local_radius(obj_page_factory_reset, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, PREF_BUTTON_RADIUS);
    lv_obj_set_style_local_border_width(obj_page_factory_reset, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, PREF_BUTTON_BORDER);
    lv_obj_align(obj_page_factory_reset, NULL, LV_ALIGN_CENTER, PREF_BUTTON_X_CENTER, -PREF_BUTTON_Y_CENTER +PREF_BUTTON_Y_OFFSET);

    obj_page_wifi_reset = lv_obj_create(lv_scr_act(), NULL);
    lv_obj_set_size(obj_page_wifi_reset, PREF_BUTTON_WIDTH, PREF_BUTTON_HEIGHT);
    ...
    lv_obj_set_style_local_radius(obj_page_wifi_reset, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, PREF_BUTTON_RADIUS);
    lv_obj_set_style_local_border_width(obj_page_wifi_reset, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, PREF_BUTTON_BORDER);
    lv_obj_align(obj_page_wifi_reset, NULL, LV_ALIGN_CENTER, PREF_BUTTON_X_CENTER, PREF_BUTTON_Y_CENTER +PREF_BUTTON_Y_OFFSET);

    obj_page_fast_cleaning = lv_obj_create(lv_scr_act(), NULL);
    lv_obj_set_size(obj_page_fast_cleaning, PREF_BUTTON_WIDTH, PREF_BUTTON_HEIGHT);
    ...
    lv_obj_set_style_local_radius(obj_page_fast_cleaning, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, PREF_BUTTON_RADIUS);
    lv_obj_set_style_local_border_width(obj_page_fast_cleaning, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, PREF_BUTTON_BORDER);
    lv_obj_align(obj_page_fast_cleaning, NULL, LV_ALIGN_CENTER, 0, -PREF_BUTTON_Y_CENTER +PREF_BUTTON_Y_OFFSET);

    obj_page_full_cleaning = lv_obj_create(lv_scr_act(), NULL);
    lv_obj_set_size(obj_page_full_cleaning, PREF_BUTTON_WIDTH, PREF_BUTTON_HEIGHT);
    ...
    lv_obj_set_style_local_radius(obj_page_full_cleaning, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, PREF_BUTTON_RADIUS);
    lv_obj_set_style_local_border_width(obj_page_full_cleaning, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, PREF_BUTTON_BORDER);
    lv_obj_align(obj_page_full_cleaning, NULL, LV_ALIGN_CENTER, 0, +PREF_BUTTON_Y_CENTER +PREF_BUTTON_Y_OFFSET);
   
    lv_obj_set_style_local_value_str(obj_page_settings,  LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, "Settings");
    lv_obj_set_style_local_value_font(obj_page_settings, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, &pref_button_font);
    ...
    lv_obj_set_style_local_value_font(obj_page_statistics, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, &pref_button_font);
    ...
    lv_obj_set_style_local_value_font(obj_page_factory_reset, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, &pref_button_font);
    ...
    lv_obj_set_style_local_value_font(obj_page_wifi_reset, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, &pref_button_font);
    ...
    lv_obj_set_style_local_value_font(obj_page_fast_cleaning, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, &pref_button_font);
    ...
    lv_obj_set_style_local_value_font(obj_page_full_cleaning, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, &pref_button_font);
