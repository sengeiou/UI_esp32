...
#include "string_it.h"
    ...
    #define LOG_TAG LINE_STRING "|" "ui_auto_cleaning"
#else
    #define LOG_TAG "ui_auto_cleaning"
#endif
...
{    
    ...
    if(oldProgress != progress)
    {
        ...
        {
            char buf[64];
            sprintf(buf, "%s (%d/%d)", AUTOCLEANING_MESSAGE_PROGRESS, current_step + 1, total_step);
...
void ui_auto_cleaning_init(void *data)
{
    ...
    lv_obj_align(obj_bar, NULL, LV_ALIGN_IN_BOTTOM_MID, CLEAN_BAR_X_OFFSET, CLEAN_BAR_Y_OFFSET);
