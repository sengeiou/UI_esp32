...
void ui_app_init(void *data)
{
    ...
    lv_table_set_col_width(app_guide, _UI_SCALE_X_(0), _UI_SCALE_Y_(300));
    lv_obj_set_style_local_border_width(app_guide, LV_TABLE_PART_BG, LV_STATE_DEFAULT, 0);
    lv_obj_set_style_local_text_font(app_guide, LV_TABLE_PART_CELL1, LV_STATE_DEFAULT, &font_en_18);
    lv_obj_set_style_local_text_font(app_guide, LV_TABLE_PART_CELL2, LV_STATE_DEFAULT, &font_en_18);
    lv_obj_set_style_local_text_font(app_guide, LV_TABLE_PART_CELL3, LV_STATE_DEFAULT, &font_en_18);
    ...
    lv_obj_set_size(obj_qr, _UI_SCALE_X_(250), _UI_SCALE_X_(250));
    ...
    lv_obj_align(obj_qr, NULL, LV_ALIGN_IN_TOP_RIGHT, _UI_SCALE_X_(-40), _UI_SCALE_Y_(90));

    for (int i = 0; i < 3; i++) {
        obj_num[i] = lv_obj_create(obj_page_app, NULL);
        lv_obj_set_size(obj_num[i], _UI_SCALE_X_(36), _UI_SCALE_X_(36));
    ...
    lv_obj_align(obj_num[0], app_guide, LV_ALIGN_OUT_LEFT_MID, _UI_SCALE_X_(10), _UI_SCALE_Y_(-25 -65));
    lv_obj_align(obj_num[1], app_guide, LV_ALIGN_OUT_LEFT_MID, _UI_SCALE_X_(10), _UI_SCALE_Y_(-25 -5));
    lv_obj_align(obj_num[2], app_guide, LV_ALIGN_OUT_LEFT_MID, _UI_SCALE_X_(10), _UI_SCALE_Y_(-25 + 55));

    lv_obj_t *white_bg = lv_obj_create(obj_qr, NULL);
    lv_obj_set_size(white_bg, _UI_SCALE_X_(210), _UI_SCALE_X_(210));
...
static void ui_app_gen_qr(void)
{
    ...
    char qr_text[20] = "www.google.com";
