...
void ui_about_init(void *data)
{
    ...
    lv_obj_set_style_local_text_font(tabel_about, LV_TABLE_PART_CELL1, LV_STATE_DEFAULT, &lv_font_montserrat_20);
    lv_obj_set_style_local_text_font(tabel_about, LV_TABLE_PART_CELL2, LV_STATE_DEFAULT, &lv_font_montserrat_20);
