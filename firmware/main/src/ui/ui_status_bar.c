...
void ui_status_bar_init(void)
{
    ...
    lv_obj_set_style_local_value_font(btn_little_time, LV_BTN_PART_MAIN, LV_STATE_DEFAULT, &lv_font_montserrat_32);
    ...
    lv_obj_set_width(btn_setting, 40);
    ...
    lv_obj_set_width(btn_battery, 40);
