...
void ui_main(void)
{
    ...
    lv_obj_set_style_local_text_font(label_loading_hint, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, &lv_font_montserrat_24);
    ...
    lv_port_sem_take();
    ui_status_bar_init();
    // ui_setting_show(NULL);
    // ui_call_stack_push(&ui_setting_func);
    lv_port_sem_give();
}
